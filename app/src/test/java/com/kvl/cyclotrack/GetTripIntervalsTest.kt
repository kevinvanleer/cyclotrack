...
class GetTripIntervalsTest {
    ...
    fun getTripIntervals_noTimeStates() {
        val testTimeStates = ArrayList<TimeState>()
        val testMeasurements = ArrayList<Measurements>()
        testMeasurements.add(Measurements(0, 0f, 0.0, 0f, 0, 0.0, 0.0, 0f, 123))
        testMeasurements.add(Measurements(0, 0f, 0.0, 0f, 0, 0.0, 0.0, 0f, 234))
        testMeasurements.add(Measurements(0, 0f, 0.0, 0f, 0, 0.0, 0.0, 0f, 345))
        testMeasurements.add(Measurements(0, 0f, 0.0, 0f, 0, 0.0, 0.0, 0f, 456))
        val intervals =
            getTripIntervals(testTimeStates.toTypedArray(), testMeasurements.toTypedArray())
    ...
    fun getTripIntervals_oneInterval_open_resolved() {
        ...
        testMeasurements.add(Measurements(0, 0f, 0.0, 0f, 0, 0.0, 0.0, 0f, 234))
        testMeasurements.add(Measurements(0, 0f, 0.0, 0f, 0, 0.0, 0.0, 0f, 345))
        testMeasurements.add(Measurements(0, 0f, 0.0, 0f, 0, 0.0, 0.0, 0f, 4567))
        val intervals =
            getTripIntervals(testTimeStates.toTypedArray(), testMeasurements.toTypedArray())
    ...
    fun getTripIntervals_multiInterval_open_resolved() {
        ...
        testMeasurements.add(Measurements(0, 0f, 0.0, 0f, 0, 0.0, 0.0, 0f, 234))
        testMeasurements.add(Measurements(0, 0f, 0.0, 0f, 0, 0.0, 0.0, 0f, 345))
        testMeasurements.add(Measurements(0, 0f, 0.0, 0f, 0, 0.0, 0.0, 0f, 8901))
        val intervals =
            getTripIntervals(testTimeStates.toTypedArray(), testMeasurements.toTypedArray())
        Assert.assertArrayEquals(arrayOf(LongRange(1234, 2345),
            LongRange(3456, 4567),
