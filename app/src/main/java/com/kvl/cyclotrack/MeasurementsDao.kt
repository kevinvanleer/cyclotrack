...
interface MeasurementsDao {
    ...
    @Query("SELECT time,speed,heartRate,speedRevolutions,speedLastEvent,speedRpm,cadenceRevolutions,cadenceLastEvent,cadenceRpm,latitude,longitude,altitude,accuracy,verticalAccuracyMeters FROM measurements WHERE tripId = :tripId ORDER BY time ASC")
